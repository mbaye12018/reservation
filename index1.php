              ...
              <div class="swiper-slide-caption section-md" style="color:white">
                <div class="container" style="margin-top:-300px;">
                 <h5 data-caption-animate="fadeInLeft" data-caption-delay="0" style="color:white">
                  ...
                  <br>
                  <div class="animated-message">Les inscriptions reprendront bientôt!!</div>
                  <style>
                    /* Style pour le message animé */
.animated-message {
    color: #f1da18; /* Couleur du texte */
    font-size: 1.5rem; /* Taille du texte */
    text-align: center; /* Centrer le texte */
    margin-top: 20px; /* Espacement au-dessus */
    animation: pulse 2s infinite; /* Appliquer l'animation de pulsation */
}
